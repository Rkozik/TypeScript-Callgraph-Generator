...
def main(root, calling_class, called_class, output_name):
    ...
    # models = ['API_Accesspoint', 'API_Event', 'API_Profile', 'API_Readings', 'API_Role', 'API_Sensor', 'API_SensorReading',
    #           'API_Server', 'API_ServerObject', 'API_User', 'API_Zone', 'CannedMessages', 'SensorTypes', 'ZoneNotification']

    # models = ['API_Accesspoint', 'API_Event', 'API_Profile', 'API_Readings', 'API_Role', 'API_Sensor',
    #           'API_SensorReading',
    #           'API_Server', 'API_ServerObject', 'API_User', 'API_Zone', 'CannedMessages', 'SensorTypes',
    #           'ZoneNotification']
        ...
        for the_class_called in typescript_class_calls:
            for the_calling_class in typescript_class_calls[the_class_called]:
                if the_calling_class == typescript_class or the_class_called == typescript_class:
                    if typescript_class_calls[the_class_called][the_calling_class] in typescript_class_methods:
                        the_time = uuid.uuid4().hex
                        calling_method_node = typescript_class_calls[the_class_called][the_calling_class] + "_" + the_time
                        class_called_node = the_class_called
